...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_web_storage_cache__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_iview__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_iview___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_iview__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__App_vue__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__libs_Ajax__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__router_index__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store__ = __webpack_require__(158);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$get = __WEBPACK_IMPORTED_MODULE_3__libs_Ajax__["b" /* fetch */];
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$post = __WEBPACK_IMPORTED_MODULE_3__libs_Ajax__["e" /* post */];
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$patch = __WEBPACK_IMPORTED_MODULE_3__libs_Ajax__["d" /* patch */];
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$put = __WEBPACK_IMPORTED_MODULE_3__libs_Ajax__["f" /* put */];
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$head = __WEBPACK_IMPORTED_MODULE_3__libs_Ajax__["c" /* head */];
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.prototype.$delete = __WEBPACK_IMPORTED_MODULE_3__libs_Ajax__["a" /* destroy */];
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#app',
  router: __WEBPACK_IMPORTED_MODULE_4__router_index__["a" /* router */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_common__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_app__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_iview__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_iview___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_iview__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__libs_Util__ = __webpack_require__(15);
...
var router = new __WEBPACK_IMPORTED_MODULE_2_vue_router__["default"]({
  routes: [__WEBPACK_IMPORTED_MODULE_3__modules_common__["c" /* loginRouter */], __WEBPACK_IMPORTED_MODULE_3__modules_common__["b" /* lockRouter */]].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(__WEBPACK_IMPORTED_MODULE_4__modules_app__["a" /* appRouter */]), [__WEBPACK_IMPORTED_MODULE_3__modules_common__["a" /* commonRouter */], __WEBPACK_IMPORTED_MODULE_3__modules_common__["f" /* page500Router */], __WEBPACK_IMPORTED_MODULE_3__modules_common__["d" /* page403Router */], __WEBPACK_IMPORTED_MODULE_3__modules_common__["e" /* page404Router */]])
});

router.beforeEach(function (to, from, next) {
  __WEBPACK_IMPORTED_MODULE_5_iview___default.a.LoadingBar.start();
  // 判断当前是否是锁定状态
  if (__WEBPACK_IMPORTED_MODULE_6__libs_Util__["a" /* default */].cache.get('locking') === 1 && to.name !== 'lock') {
    next({ name: 'lock' });
  } else if (__WEBPACK_IMPORTED_MODULE_6__libs_Util__["a" /* default */].cache.get('locking') === 0 && to.name === 'lock') {
    next(false);
  } else {
    // 判断是否已经登录且前往的页面不是登录页
    if (!__WEBPACK_IMPORTED_MODULE_6__libs_Util__["a" /* default */].cache.get('token') && to.name !== 'login') {
      next({ name: 'login' });
      // 判断是否已经登录且前往的是登录页
    } else if (__WEBPACK_IMPORTED_MODULE_6__libs_Util__["a" /* default */].cache.get('token') && to.name === 'login') {
      next({ name: 'home' });
    } else {
      next();
    }
...
router.afterEach(function (to) {
  ...
  __WEBPACK_IMPORTED_MODULE_5_iview___default.a.LoadingBar.finish();
  window.scrollTo(0, 0);
});
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return loginRouter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return page404Router; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return page403Router; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return page500Router; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return lockRouter; });
...
var page404Router = {
  ...
  component: function component(resolve) {
    __webpack_require__.e/* require */(5).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(180)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  }
};
...
var page500Router = {
  ...
  name: 'error-500',
  component: function component(resolve) {
    __webpack_require__.e/* require */(4).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(182)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  }
};
...
var lockRouter = {
  ...
  name: 'lock',
  component: function component(resolve) {
    __webpack_require__.e/* require */(7).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(183)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
  }
};
...
var commonRouter = {
  ...
  redirect: '/home',
  children: [{ path: 'home', name: 'home', meta: { title: '首页' }, component: function component(resolve) {
    ...
    } }, { path: 'profile', title: '个人中心', name: 'profile', meta: { title: '个人中心' }, component: function component(resolve) {
...
var update = __webpack_require__(14)("10e5119d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2e3fc0c6\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_less-loader@4.0.5@less-loader/dist/cjs.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./Main.vue", function() {
     var newContent = require("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-2e3fc0c6\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_less-loader@4.0.5@less-loader/dist/cjs.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./Main.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_header_icon_vue__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_header_icon_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_header_icon_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_header_ownspace_vue__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_header_ownspace_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_header_ownspace_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_router_scroll_vue__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_router_scroll_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_router_scroll_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_left_menu_vue__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_left_menu_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_left_menu_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    headerIcon: __WEBPACK_IMPORTED_MODULE_0__components_header_icon_vue___default.a,
    headerOwnspace: __WEBPACK_IMPORTED_MODULE_1__components_header_ownspace_vue___default.a,
    routerScroll: __WEBPACK_IMPORTED_MODULE_2__components_router_scroll_vue___default.a,
    leftMenu: __WEBPACK_IMPORTED_MODULE_3__components_left_menu_vue___default.a
  },
  data: function data() {
    return {
...
Component.options.__file = "resources\\assets\\js\\components\\header-icon.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7e578db2", Component.options)
  } else {
    hotAPI.reload("data-v-7e578db2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("48725e6a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7e578db2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./header-icon.vue", function() {
     var newContent = require("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7e578db2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./header-icon.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-7e578db2", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\header-ownspace.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5b342279", Component.options)
  } else {
    hotAPI.reload("data-v-5b342279", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("8c19c3b4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5b342279\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./header-ownspace.vue", function() {
     var newContent = require("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5b342279\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./header-ownspace.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-5b342279", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\router-scroll.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7eee30ec", Component.options)
  } else {
    hotAPI.reload("data-v-7eee30ec", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-7eee30ec", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\left-menu.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0b92d39e", Component.options)
  } else {
    hotAPI.reload("data-v-0b92d39e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("879aaa20", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0b92d39e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./left-menu.vue", function() {
     var newContent = require("!!../../../../node_modules/_css-loader@0.28.9@css-loader/index.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0b92d39e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!../../../../node_modules/_vue-loader@13.7.1@vue-loader/lib/selector.js?type=styles&index=0!./left-menu.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-0b92d39e", module.exports)
  }
}
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      [_c("Icon", { attrs: { type: "navicon", size: "40" } })],
                      1
                    )
                  ],
                  1
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      [
                        _vm.$route.path !== "/home"
                          ? _c("BreadcrumbItem", { attrs: { href: "/home" } }, [
                              _vm._v("首页")
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.$route.meta.parent
                          ? _c("BreadcrumbItem", [
                              _vm._v(_vm._s(_vm.$route.meta.parent))
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-2e3fc0c6", module.exports)
  }
}
...
var appRouter = [{
  ...
  children: [{ path: 'document.list', name: 'admin.document.list', meta: { title: '文档管理', icon: 'ios-list-outline', parent_icon: 'clipboard', parent: '文档管理' }, component: function component(resolve) {
      __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(186)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
    } }]
}];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_app__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_messages__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_markdown__ = __webpack_require__(175);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_Util__ = __webpack_require__(15);
