<template lang="html">
  <div class="box-flex">
    <div class="box-flex-list">
      ...
      <Group v-on:visibleChange="visibleChangeGroup" :show="groupModalShow" :row="groupId"></Group>
  </div>
</template>
      ...
      Columns: [{
        ...
        'render': (h, {
          ...
          return (<button-group>
            ...
            <i-button on-click={()=>{this.allotButton(row)}} size="small">分配权限</i-button>
            <i-button on-click={()=>{this.groupButton(row)}} size="small">分配用户组</i-button>
          </button-group>)
        }
      }],
      Datas: [],
